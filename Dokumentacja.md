...
Aplikacja została zaprojektowana i zaimplementowana w oparciu o architekturę Model-View-Controller (MVC). Wzorzec ten zapewnia ścisłą separację odpowiedzialności, co ułatwia konserwację, testowanie oraz ewentualną rozbudowę oprogramowania w przyszłości.
...
Ekran główny administratora agreguje kluczowe wskaźniki finansowe aplikacji. Prezentuje łączną sumę wszystkich wydatków, liczbę zdefiniowanych kategorii oraz tabelę ostatnich transakcji.
